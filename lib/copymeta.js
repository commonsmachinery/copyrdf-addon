...
exports.copyRDFXML = function copyRDFXML(window, rdf) {
...
exports.copyImage = function copyImage(window, img, rdf, subjectURI) {
...
exports.hasClipboardImage = function hasClipboardImage() {
    return gClipboard.hasDataMatchingFlavors(
        gImageTypes, gImageTypes.length, Ci.nsIClipboard.kGlobalClipboard);
};


exports.getClipboardImage = function getClipboardImage(window) {
    ...
    if (rdf && !isRDFXML(rdf)) {
        ...
        console.log('weird RDF (UTF-8 as UTF-16?): ' + encodeURIComponent(rdf.substring(0, 40)));
        ...
        if (bytes.length > 0) {
            ...
            if (!isRDFXML(rdf)) {
                console.log('still weird RDF, passing it on anyway: ' +
                            encodeURIComponent(rdf.substring(0, 40)));
            }
        }
        else {
...
isRDFXML = function isRDFXML(str) {
    if (str.startsWith('\uFEFF')) {
        // Drop UCS2 BOM
...
SupportsInterfacePointer = function SupportsInterfacePointer(obj) {
...
SupportsString = function SupportsString(str) {
...
Transferable = function Transferable(source) {
