...
//
//   cfx run --static-args='{ "standardSiteRulesURL": "", "localSiteRulesFile": "/path/to/copyrdf-addon/site-rules.json" }'
//
...
var copyMetadata = contextMenu.Item({
    ...
    context: contextMenu.SelectorContext('img[' + gMetadataAttr + ']'),
